...
HD_PWD='C:/Users/PMYLS/Desktop/DSDLab3/DSDLab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log givencode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source givencode.tcl
