...
HD_PWD='C:/Users/PMYLS/Desktop/DSDLab3/DSDLab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log givencode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source givencode.tcl -notrace
